#!/usr/bin/env python3
"""
etsy-scraper — 2captcha Scraper API edition (fourth engine)
=================================================================
...
def parse_args():
    ...
    p.add_argument("--url", default=None,
                   help="Etsy listing URL (/search?q=..., /c/<taxonomy>, "
                        ...
                        "ETSY_URL is set in the environment or in .env.")
    ...
    p.add_argument("--out", default="etsy_products_scraperapi", help="Output file prefix")
